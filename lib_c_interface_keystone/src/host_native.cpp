...
void ipfs_keystone_tee(char* eappName);
...
void ipfs_keystone(int isAES) {
    switch (isAES)
    {
    case AES:
        ipfs_keystone_tee("aes");
        break;
    case SM4:
        ipfs_keystone_tee("sm4");
        break;
    case demo:
        ipfs_keystone_tee("hello-native");
        break;
    default:
        break;
    }
